        ...
        <div className="flex flex-col gap-8 w-full">
          ...
          <div className="w-full flex  items-center justify-between px-5 py-8 md:px-8 bg-gray-800 rounded-2xl border border-gray-700/50 shadow-lg shadow-gray-800/50 hover:shadow-gray-700/30  transition-all duration-200">
            ...
            <div className="flex items-center gap-3 md:gap-4">
              ...
              <Link target="_blank" rel="noopener noreferrer" href="https://x.com/gentlemanwebdev" className="w-[2.5rem] h-[2.5rem] flex items-center justify-center rounded-full bg-gray-700 hover:bg-blue-500 transition-all duration-200">
                <LuTwitter size={20} />
              </Link>
